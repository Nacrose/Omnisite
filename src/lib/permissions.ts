...
export const ROLE_TEMPLATES: Record<Role, RoleTemplate> = {
  PM: {
    ...
    visibleModules: 'ALL',
    editableModules: [
      'dashboard', 'boq', 'scheduler', 'daily-ops', 'equipment', 'procurement',
      'financials', 'subcontractor', 'drawings', 'correspondence', 'admin',
      'reports', 'qs', 'time-attendance', 'chat',
    ],
  },
  SITE_ENGINEER: {
    id: 'SITE_ENGINEER',
    ...
    editableModules: [
      'dashboard', 'boq', 'scheduler', 'daily-ops', 'equipment', 'procurement',
      'subcontractor', 'drawings', 'correspondence', 'reports', 'qs',
      'time-attendance', 'chat',
    ],
  },
  STOREKEEPER: {
    id: 'STOREKEEPER',
    ...
    visibleModules: [
      'dashboard', 'daily-ops', 'procurement', 'reports', 'chat',
    ],
  ...
  FOREMAN: {
    ...
    visibleModules: [
      'dashboard', 'daily-ops', 'time-attendance', 'chat',
    ],
