 ...
 *
 * Includes three subcontractors exercising the three SC item shapes:
 *  - SC-01 composite drain rate (linear-meter mapping to multiple BOQ codes)
 *  - SC-02 rebar fabrication (single composite mapping)
 *  - SC-03 tunneling with conditional support items (rock-class driven)
 */
