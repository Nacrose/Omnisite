...
export const INITIAL_VENDORS: Vendor[] = [
  // ─── Suppliers (V-001 … V-004) — migrated from src/data/seed/admin.ts ────
  {
    ...
    bankAccountName: 'Udaipur Cement Ltd',
  ...
  },
  {
    ...
    bankAccountName: 'Shivam Cement Pvt Ltd',
    bankAccountNo: '09876543210987',
  ...
  },
  {
    ...
    bankAccountName: 'Pashupati Steel Industries',
    bankAccountNo: '11223344556677',
  ...
  },
  {
    ...
    bankAccountName: 'Trishuli Sand Suppliers',
    bankAccountNo: '99887766554433',
  ...
  // bank + paymentTerms + docs as new unified fields.
  {
    ...
    bankAccountName: 'M/S Lama Constructions',
    bankAccountNo: '22334455667788',
  ...
  },
  {
    ...
    bankAccountName: 'Shrestha Steel Works',
    bankAccountNo: '55667788990011',
    bankName: 'Everest Bank Nepal',
    bankBranch: 'Bhaktapur',
    bankIfsc: 'EVBLNPKA',
    creditDays: 21,
    advancePct: 10,
    retentionPct: 5,
  ...
  },
  {
    ...
    bankAccountName: 'Himal Tunneling Co.',
    bankAccountNo: '77889900112233',
    bankName: 'Prime Commercial Bank',
    bankBranch: 'Suryabinayak',
    bankIfsc: 'PCBLNPKA',
    creditDays: 30,
    advancePct: 10,
    retentionPct: 5,
