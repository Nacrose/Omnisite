import type { Task } from '@/components/modules/scheduler/types'

/**
 * Seed task tree for the demo project scheduler.
 *
 * Used as the initial task list rendered by the Scheduler module.
 */
