...
export type UpdateNode = (code: string, field: 'committed' | 'actual' | 'forecast', value: number) => void
...
export function CbsTable(props: CbsTableProps) {
  const {
    items, depth, expanded, selectedCode, editing, cbsIsVisible,
    onSelectCode, toggleExpand, updateNode, setEditing,
  } = props
