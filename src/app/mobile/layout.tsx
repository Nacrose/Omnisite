...
export default function MobileLayout({ children }: { children: React.ReactNode }) {
  ...
  return (
    <div className="bg-background flex h-screen flex-col overflow-hidden">
      {/* ─── Header ──────────────────────────────────────────────────── */}
      <header className="border-border safe-area-top flex h-12 flex-shrink-0 items-center justify-between border-b px-4">
      ...
      {/* ─── Content ────────────────────────────────────────────────── */}
      <main className="safe-area-bottom flex-1 overflow-y-auto pb-16">{children}</main>

      {/* ─── Bottom Tab Bar ──────────────────────────────────────────── */}
      <nav className="border-border bg-background safe-area-bottom fixed right-0 bottom-0 left-0 z-50 flex h-14 items-center justify-around border-t">
        {TABS.map((tab) => {
          const Icon = tab.icon
